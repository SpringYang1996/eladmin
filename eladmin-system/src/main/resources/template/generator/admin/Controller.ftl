...
public class ${className}Controller {
    ...
    public ResponseEntity get${className}s(@ModelAttribute ${className}QueryCriteria criteria,@ModelAttribute IPage<${className}> page){
    ...
    public ResponseEntity create(@Validated @RequestBody @ModelAttribute ${className} resources){
    ...
    public ResponseEntity update(@Validated @RequestBody @ModelAttribute ${className} resources){
